...
class PipelineRunner {
    ...
    RunYamlPipeline(webApi) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            logger_1.Logger.LogInfo(`Triggering pipeline at : "${pipelinesUrl}"`);
            logger_1.Logger.LogInfo(`Headers : "${JSON.stringify(headers)}"`);
            logger_1.Logger.LogInfo(`Body : "${JSON.stringify(pipelineParameters)}"`);
